		...
		<div class="questContent__wrapper">
			<div class="questContent__items">
						...
						<ul class="questContent__forLabel_list">
							<li>
								<label for="opt_1_s" class="label">
									<input
										type="radio"
										v-model="questions.quest_1.quest_1"
										id="opt_1_s"
										class="input_hidden"
										value="Cтроительная"
									/>
						...
						<ul class="questContent__forLabel_list">
							<li>
								<label for="opt_1_1c" class="label">
									<input
										type="radio"
										v-model="questions.quest_1.quest_2"
										id="opt_1_1c"
										class="input_hidden"
										value="1 категории"
									/>
						...
						<ul class="questContent_list">
							<li>
								<label for="opt_2_r" class="label">
									<input
										type="radio"
										v-model="questions.quest_2"
										id="opt_2_r"
										class="input_hidden"
										value="Резидент Казахстана"
									/>
									<span class="radio"></span>
				...
				<div class="questContent__items_item" v-if="step === 3">
					<div class="questContent__forLabel">
						<ul
							class="questContent_list"
							v-if="questions.quest_1.quest_2 != 'Нужна помощь'"
						>
							<li>
								<label for="opt_3_yes" class="label">
									<input
										type="radio"
										v-model="questions.quest_3.quest"
										id="opt_3_yes"
										class="input_hidden"
										value="Есть"
									/>
						...
						<ul class="questContent_list" v-else>
							<li>
								<label for="opt_help_4_s" class="label">
									<input
										type="radio"
										v-model="questions.quest_3.help"
										id="opt_help_4_s"
										class="input_hidden"
										value="Строительство"
									/>
							...
							<li>
								<label for="opt_help_4_sp" class="label">
									<input
										...
										id="opt_help_4_sp"
										class="input_hidden"
										value="Проектирование и строительство"
									/>
									<span class="radio"></span>
						...
						>
							<li>
								<label for="opt_5_3_yes" class="label">
									<input
										type="radio"
										v-model="questions.quest_4.quest"
										id="opt_5_3_yes"
										class="input_hidden"
							...
							<li>
								<label for="opt_5_3_help" class="label">
									<input
										...
										id="opt_5_3_help"
										class="input_hidden"
										value="Нужна помощь в определении и аттестации"
									/>
									<span class="radio"></span>
						...
						<ul class="questContent_list" v-else>
							<li>
								<label for="opt_help_5_g" class="label">
									<input
										type="radio"
										v-model="questions.quest_4.help"
										id="opt_help_5_g"
										class="input_hidden"
				...
				<div
					class="questContent__items_item"
					v-if="
						step === 5 &&
						questions.quest_1.quest_2 === '3 категории' &&
						questions.quest_2 !== 'Резидент Казахстана'
					"
				>
					<div class="questContent__forLabel">
						<ul class="questContent_list">
							<li>
								<label for="opt_413_yes" class="label">
									<input
										type="radio"
										v-model="questions.quest_5.quest_2"
										id="opt_413_yes"
										class="input_hidden"
										value="Планирую"
									/>
				...
				<div
					class="questContent__items_item"
					v-if="step === 5 && questions.quest_1.quest_2 !== '3 категории'"
				>
					<div class="questContent__forLabel">
						<ul
							class="questContent_list"
							v-if="
								questions.quest_1.quest_2 === 'Нужна помощь' &&
								questions.quest_2 !== 'Резидент Казахстана'
							"
						>
							<li>
								<label for="opt_41_yes" class="label">
									<input
										type="radio"
										v-model="questions.quest_5.help_1"
										id="opt_41_yes"
										class="input_hidden"
										value="Планирую"
									/>
						...
						<ul
							...
							"
						>
							<p class="questContent__forLabel_title">
								Опишите ключевые параметры проектируемого или подлежащего
								строительству объекта
							</p>
							<input
								type="text"
								class="input"
								v-model="questions.quest_5.help_2"
							/>
						</ul>
						...
						<ul class="questContent_list" v-else>
							<li>
								<label for="opt_47_yes" class="label">
									<input
										type="radio"
										v-model="questions.quest_5.quest_1"
										id="opt_47_yes"
										class="input_hidden"
										value="Есть в наличии"
									/>
				...
				>
					<div class="questContent__forLabel">
						<ul
							class="questContent_list"
							v-if="questions.quest_1.quest_2 === '1 категории'"
						>
							<li>
								<label for="opt_5_с_1_1" class="label">
									<input
										type="radio"
										v-model="questions.quest_6.quest_1"
										id="opt_5_с_1_1"
										class="input_hidden"
										value="Акты приемки работ государственной комиссией, от 10 экземпляров"
									/>
									<span class="radio"></span>
									Акты приемки работ государственной комиссией, от 10
									экземпляров
								</label>
							</li>
							<li>
								<label for="opt_5_с_1_2" class="label">
									<input
										...
										id="opt_5_с_1_2"
										class="input_hidden"
										value="Акты выполненных работ по договорам субподряда, от 20 экземпляров"
									/>
									<span class="radio"></span>
									Акты выполненных работ по договорам субподряда, от 20
									экземпляров
								</label>
							</li>
							<li>
								<label for="opt_5_с_1_3" class="label">
									<input
										...
										id="opt_5_с_1_3"
										class="input_hidden"
										value="Нужна помощь в определении"
									/>
									<span class="radio"></span>
						...
						<ul class="questContent_list" v-else>
							<li>
								<label for="opt_5_с_2_1" class="label">
									<input
										type="radio"
										v-model="questions.quest_6.quest_2"
										id="opt_5_с_2_1"
										class="input_hidden"
										value="Акты приемки работ государственной комиссией, от 5 экземпляров"
									/>
									<span class="radio"></span>
							...
							<li>
								<label for="opt_5_с_2_2" class="label">
									<input
										...
										id="opt_5_с_2_2"
										class="input_hidden"
										value="Акты выполненных работ по договорам субподряда, от 10 экземпляров"
									/>
									<span class="radio"></span>
									Акты выполненных работ по договорам субподряда, от 10
									экземпляров
								</label>
							</li>
							<li>
				...
				<div
					class="questContent__items_item questContent_gifts"
					v-if="
						(step === 5 &&
							questions.quest_1.quest_2 === '3 категории' &&
							questions.quest_2 === 'Резидент Казахстана') ||
				...
				>
					...
					<div class="questContent_gifts_item">
						...
						<button
							class="btn btn-pulse btn_effect btn_next"
				...
				>
					<div class="questContent__forLabel">
						<p class="questContent__forLabel_title">
							Выберите предпочитаемые способы связи
						</p>
						...
						<p class="questContent__forLabel_title">
							Введите номер телефона и покупатель свяжется с вами в ближайшее
							время
						</p>
						<div class="questContent__form">
							...
							<button
								class="btn btn-pulse btn_effect questContent__form_btn"
								@click="submitQuiz"
							>
								Получить расчёт и&nbsp;подарок
							</button>
							<p class="alarm">
								Оставляя контактную информацию, вы соглашаетесь
				...
				<div class="questContent__items_item" v-if="step === 20">
					<div class="questContent__finish">
						...
						<a :href="siteUrl" class="btn questContent__finish_btn"
							>Перейти на сайт</a
						>
					</div>
				</div>
		...
		methods: {
			...
			submitQuiz(e) {
				...
				if (this.isValidPhone) {
					...
					let text = [
						`Тип лицензии: ${this.questions.quest_1.quest_1}`,
